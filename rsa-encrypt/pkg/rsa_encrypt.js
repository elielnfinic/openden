...
* @returns {string}
*/
export function get_mnemonic() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_mnemonic(retptr);
...
* @returns {string}
*/
export function check_mnemonic(phrase) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.check_mnemonic(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        return getStringFromWasm0(r0, r1);
    } finally {
...
export function encrypt_data(data) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.encrypt_data(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        return getStringFromWasm0(r0, r1);
    } finally {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('rsa_encrypt_bg.wasm', import.meta.url);
    }
    const imports = getImports();
